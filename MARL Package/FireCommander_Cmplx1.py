...
from FireCommander_Cmplx1_Utilities import EnvUtilities

Agent_Util = EnvUtilities()


# Full FireCommander Environment
class FireCommanderHard(object):
...
if __name__ == '__main__':
    # initialize the env
    env = FireCommanderHard(online_vis=True)
    env.env_init()
